FixKeyinUSB ไฟล์สำหรับแก้ไข Key ในไฟล์  Text กับ Excel ให้ตรงกัน
ข้อควรรู้

1. ต้องเสียบ Flash Drive ของ NECTEC (ใช้ได้เฉพาะรุ่นของปี 2559 ขั้นไปเท่านั้น)
2. ต้องมีโปรแกรม Microsoft Excel (Version 2000 ขึ้นไป)
3. ต้องรันด้วยระบบปฏิบัติการ Windows XP ขึ้นไป (แนะนำให้เป็นรุ่น Pro)
4. ไฟล์จะต้องรันจาก C:\LDSW_License_Checker เท่านั้น
